...
export default function SearchOverlay() {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 70, background: "rgba(249,249,247,0.97)", backdropFilter: "blur(8px)", padding: isMobile ? "56px 20px 32px" : "64px 56px", animation: "msFadeIn 0.28s ease both", overflowY: "auto" }}>
      <div onClick={toggleSearch} className="hv-text-accent" style={{ position: "absolute", top: isMobile ? "22px" : "28px", right: isMobile ? "20px" : "40px", cursor: "pointer", fontFamily: "Outfit,sans-serif", fontSize: "10.5px", fontWeight: 800, letterSpacing: "1.6px", color: "#9A9A92" }}>
        CLOSE ✕
      </div>
      <input
        value={query}
        ...
        autoFocus
        style={{ width: "100%", maxWidth: "900px", border: "none", borderBottom: "2px solid #181818", background: "transparent", fontFamily: "Outfit,sans-serif", fontSize: isMobile ? "26px" : "44px", fontWeight: 700, letterSpacing: "-1.4px", padding: "0 0 16px", outline: "none", color: "#181818" }}
      />
